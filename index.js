...
var username = readlineSync.question(chalk.yellowBright("Hello Friend! What is your Name? "));

//general instructions
console.log(chalk.yellow("\nHey " + chalk.underline(username) + "!!! Let's play some GK questionairre with you."));
console.log( chalk.yellow( "Let's test your GK knowledge  \n" ));

console.log(chalk.bgRed("Follow some listed Instructions :- "));
console.log("1. There are total 5 questions in the quiz.\n2. Give your answers in form of 1, 2, 3 or 4 \n3. Each correct answer will give you one positive score\n4. There is no negative marking.\n  ");
